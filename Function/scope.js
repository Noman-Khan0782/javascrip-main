...
// console.log(a);//error not define because of globe scope
console.log(b);
// console.log(c);//error not define because of globe scope
checkscope()
...
// =============problem================
//name2()//error in expression we cammot call fuction on the top but problem in decleration
